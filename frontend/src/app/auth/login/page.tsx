    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="glass-dark p-10 rounded-3xl shadow-2xl animate-fade-in-up border border-white/10">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-5">
              <div>
                <label className="block text-xs font-bold text-gray-400 mb-2 uppercase tracking-wider">E-posta Adresi</label>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 bg-white/10 border-white/20 text-white rounded focus:ring-offset-0 focus:ring-1 focus:ring-white transition-colors"
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-400 hover:text-white transition-colors cursor-pointer select-none">
                  Beni hatırla
                </label>
              </div>

              <div className="text-sm">
                <Link href="/auth/forgot-password" className="font-semibold text-gray-400 hover:text-white transition-colors">
                  Şifremi unuttum
                </Link>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-500">
              Hesabınız yok mu?{' '}
              <Link href="/auth/register" className="font-bold text-white hover:underline transition-all">
                Hemen kayıt olun
              </Link>
            </p>
          </div>
        ...
        <div className="text-center text-white/20 text-xs tracking-widest uppercase">
          <p>© 2025 TeeStore. Güvenli giriş.</p>
        </div>
      </div>
    </div>
  );
