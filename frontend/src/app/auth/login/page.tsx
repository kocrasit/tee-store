      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="glass-card p-10 rounded-3xl shadow-2xl animate-fade-in-up">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/auth/forgot-password" className="font-semibold gradient-text hover:opacity-80 transition-opacity">
                  Şifremi unuttum
                </Link>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full btn-gradient py-4 text-base font-bold disabled:opacity-50 disabled:cursor-not-allowed group"
            >
              {isLoading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              Hesabınız yok mu?{' '}
              <Link href="/auth/register" className="font-bold gradient-text hover:opacity-80 transition-opacity">
                Hemen kayıt olun
              </Link>
            </p>
          </div>
